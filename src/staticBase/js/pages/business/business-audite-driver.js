define(function(require,exports,module){
  var cityData = require('utils/kspicker/cityData.js'),//重要 ,code 应为 string
      ...
      _user = require("pages/user/user-common.js");
  ...
  <div class="wrap">
    ...
    <div class="content_box p_b-0">
      ...
      <div class="weui-btn-area mb-20">
        <a class="weui-btn weui-btn_primary orange_btn" href="javascript:;" ref="driver_submit"  v-show="!isReadonly" @click="submit" >确认提交</a> <!--  -->
      </div>
