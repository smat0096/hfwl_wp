define(['async!BMap'], function() {
   ...
   * Author 岳晓 
   *
   * 对百度地图的事件扩展，目前扩展了oneclick和longclick, 
   * 解决某些设备click不执行的问题 
  ...
  (function(){  
      BMap.Marker.prototype.on = BMap.Map.prototype.on=function(evt,fn,option){  
          var _option = {  
              canBubble:true  
          }  
          ...
          if(inArray(evt,evtList) && $this.constructor === BMap.Map){  
      ...
      BMap.Map.prototype.centerAndZoom  = function(){  
          ...
          var $this = this;  
          centerAndZoom.apply(this,arguments); return 
